...
const CATEGORIES = ["Runway", "Street Style", "Editorial", "Sustainable"] as const;
...
const LUXURY_PRODUCTS: Product[] = [
  { 
    ...
    description: "Handcrafted in Mumbai with 24-karat gold embroidery and ethically sourced gemstones."
  },
  { 
    id: "p2", 
    ...
    description: "A collector's piece from the 2004 collection. Authentic leather with patina that whispers of history."
  },
  { 
    id: "p3", 
    ...
    description: "An icon redefined. 18K yellow gold with a legacy spanning decades of timeless elegance."
  },
  { 
    id: "p4", 
    ...
    description: "The architect of androgynous power. Saint Laurent's most revolutionary silhouette, continuously reimagined."
  },
];
...
const VOGUE_ARTICLES: Partial<Article>[] = [
  {
    ...
    subtitle: "Fashion's most coveted evening transcends celebrity to become a referendum on historical preservation, cultural ownership, and the power of restraint in an age of excess.",
    category: "Editorial",
    tags: ["Met Gala", "Red Carpet", "Cultural Moment", "Heritage"],
    mainImage: "https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=1600&h=900&fit=crop",
    authorId: "a3",
    excerpt: "When art history meets the red carpet, fashion becomes philosophy."
  },
  {
    title: "Paris Couture Week: The Architects of Silence",
    subtitle: "In a season defined by architectural precision and the strategic deployment of emptiness, Schiaparelli and Dior prove that luxury's future belongs to those who understand the power of negative space.",
    category: "Runway",
    tags: ["Paris", "Couture", "Luxury", "Design"],
    mainImage: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=1600&h=900&fit=crop",
    authorId: "a1",
    excerpt: "Less is more. But the 'less' is everything."
  },
  {
    title: "Sabyasachi: How India Conquered Global Luxury",
    subtitle: "From the textile workshops of Kolkata to the penthouses of Manhattan, one designer has fundamentally altered what the world considers luxury. His collections rewrite the grammar of elegance.",
    category: "Sustainable",
    tags: ["India", "Heritage", "Craftsmanship", "Global Impact"],
    mainImage: "https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=1600&h=900&fit=crop",
    authorId: "a2",
    excerpt: "Tradition meets the future on Mumbai's runways."
  },
  {
    title: "Cannes 2025: When Cinema Met Fashion and Changed Everything",
    subtitle: "On the French Riviera, film and fashion dissolved into a single aesthetic language. The result? A new kind of beauty that transcends the boundaries of both industries.",
    category: "Editorial",
    tags: ["Cannes", "Film", "Red Carpet", "Cultural Shift"],
    mainImage: "https://images.unsplash.com/photo-1483985988355-763728e1935b?w=1600&h=900&fit=crop",
    authorId: "a1",
    excerpt: "Where storytelling becomes wearable art."
  },
  {
    title: "Street Style as Subversion: SoHo's Elite Challenge the Status Quo",
    subtitle: "New York's most photographed personalities have abandoned the aesthetic of casual luxury. In its place: a calculated, almost architectural approach to dressing that commands attention.",
    category: "Street Style",
    tags: ["NYC", "Street Style", "Cultural Commentary", "Trends"],
    mainImage: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=1600&h=900&fit=crop",
    authorId: "a3",
    excerpt: "Effortless is dead. Intentional is everything."
  },
  {
    title: "Priyanka, Deepika, Alia: The Globalization of Bollywood Beauty",
    subtitle: "Three women. Two continents. One seismic shift in how the world defines sophistication, power, and what it means to be a global style icon in the 21st century.",
    category: "Editorial",
    tags: ["Bollywood", "Global Icons", "Representation", "Culture"],
    mainImage: "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=1600&h=900&fit=crop",
    authorId: "a2",
    excerpt: "From Bollywood to the world stage: a new kind of power emerges."
  },
  {
    title: "Inside Paris's Most Exclusive Afterparties: Where the Real Show Begins",
    subtitle: "When the runway lights fade, fashion's most influential figures retreat to spaces that define culture. We go inside the soirées that shape tomorrow's trends.",
    category: "Runway",
    tags: ["Paris", "Nightlife", "Exclusive Access", "Industry"],
    mainImage: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=1600&h=900&fit=crop",
    authorId: "a1",
    excerpt: "Where beauty meets power, and power dances into the night."
  },
  {
    title: "Vintage as Philosophy: Gen Z's Rejection of Newness",
    subtitle: "A generation trained on fast fashion is now rewriting the rules by looking backward. Vintage shopping has become an act of resistance, nostalgia a form of rebellion.",
    category: "Sustainable",
    tags: ["Vintage", "Sustainability", "Gen Z", "Cultural Shift"],
    mainImage: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=1600&h=900&fit=crop",
    authorId: "a4",
  ...
  },
  {
    ...
    subtitle: "Bushwick lofts and SoHo basements are birthing a new kind of designer—one who refuses commerce, rejects trends, and creates purely from vision. The industry is watching.",
    category: "Street Style",
    tags: ["NYC", "Avant-Garde", "Emerging Designers", "Underground"],
    mainImage: "https://images.unsplash.com/photo-1558769132-92e717d613cd?w=1600&h=900&fit=crop",
    authorId: "a3",
    excerpt: "When fashion transcends commerce and becomes prophecy."
  },
  {
    title: "The Jaipur Literature Festival Style Report: When Intellect Meets Aesthetic",
    subtitle: "India's most influential writers, thinkers, and artists gathered to discuss the future of ideas. What they wore told a different, equally compelling story.",
    category: "Sustainable",
    tags: ["India", "Jaipur", "Culture", "Intellectual Fashion"],
    mainImage: "https://images.unsplash.com/photo-1596783074918-c84cb06531ca?w=1600&h=900&fit=crop",
    authorId: "a2",
    excerpt: "Philosophy wears clothes. And they are exquisite."
  },
  {
    title: "The Dior Show in Mumbai: When Haute Couture Met Monument",
    subtitle: "Against the backdrop of the Gateway of India, Dior's cruise collection challenged the notion of where luxury belongs. The result: a moment that altered fashion's geography forever.",
    category: "Runway",
  ...
  },
  {
    ...
    subtitle: "A young actor in harnesses, backless halters, and bias-cut silks. Chalamet isn't just wearing fashion—he's demolishing its assumptions about what men should be.",
    category: "Editorial",
    tags: ["Men's Fashion", "Red Carpet", "Masculinity", "Cultural Shift"],
    mainImage: "https://images.unsplash.com/photo-1617137984095-74e4e5e3613f?w=1600&h=900&fit=crop",
    authorId: "a4",
    excerpt: "The future of masculinity is fluid, fearless, and absolutely fabulous."
  },
  {
    title: "Copenhagen Fashion Week: Sustainability Becomes Luxury",
    subtitle: "In Scandinavia's design capital, a radical idea is taking hold: true luxury must be sustainable. The industry's most innovative brands are proving ethical fashion can be exquisite.",
    category: "Sustainable",
  ...
  },
  {
    ...
    subtitle: "Virtual runways, NFT collections, and digital-only garments are no longer experiments—they're the future. Meet the designers building fashion empires that exist only in pixels.",
    category: "Editorial",
    tags: ["Digital Fashion", "NFT", "Innovation", "Future"],
    mainImage: "https://images.unsplash.com/photo-1558769132-cb1aea1a5aaa?w=1600&h=900&fit=crop",
    authorId: "a4",
  ...
  },
  {
    ...
    subtitle: "After decades of maximalist excess, Milan's most influential houses are embracing a new aesthetic philosophy. The result is powerful, precise, and undeniably Italian.",
    category: "Runway",
  ...
  },
  {
    ...
    subtitle: "Harajuku's experimental youth culture has long influenced global fashion. Now, their most radical ideas are being adopted by luxury brands worldwide. The student has become the teacher.",
    category: "Street Style",
    tags: ["Tokyo", "Harajuku", "Youth Culture", "Global Influence"],
    mainImage: "https://images.unsplash.com/photo-1529139574466-a303027c1d8b?w=1600&h=900&fit=crop",
    authorId: "a4",
    excerpt: "From Tokyo's streets to the world's runways in one cultural moment."
  }
];
